...
//CODE HERE
const compareNums = (number, biggerNumber) => {
  if (number > biggerNumber) {
    console.log(number)
  } else if (number < biggerNumber) {
    console.log(biggerNumber)
  } else {
    console.log(number || biggerNumber)
  }
}
compareNums(5, 5);
...
function emailCheck(email) {
  ...
  if (emailStr.includes('@')) {
    console.log('email verfied :', emailStr)
  } else {
    console.log('must provide a valid email address')
  }
}
emailCheck('hahsh@gmail.com   ');
...
let arrayIsAscending = arrNumber(sampleArray)
